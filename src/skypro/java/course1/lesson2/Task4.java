...
public class Task4 {
    public static void main(String[] args) {
        ...
        int weightToLoose = 7000; // вес в граммах, который необходимо сбросить
        ...
        int totalDays1 = weightToLoose / weightLostPerDay1;
        int totalDays2 = weightToLoose / weightLostPerDay2;
